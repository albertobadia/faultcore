...
def test_removed_utility_symbols_are_not_exported() -> None:
    with pytest.raises(AttributeError):
        object.__getattribute__(faultcore, "is_interceptor_loaded")
    with pytest.raises(AttributeError):
        object.__getattribute__(faultcore, "get_interceptor_path")
    with pytest.raises(AttributeError):
        object.__getattribute__(faultcore, "get_fault_metrics")
